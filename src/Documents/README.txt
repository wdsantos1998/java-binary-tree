Name: Wesley dos Santos
ID:0140110
Date: 11/04/2022
Class Number (335) and Daniel Oliveira
The Assignment Number: Binary Search Tree (using LinkedList)
...
Extra notes: 
The code runs properly and according to the output example. Notes in the code